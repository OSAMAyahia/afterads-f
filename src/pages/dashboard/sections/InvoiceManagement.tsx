      ...
      <div className="bg-gradient-to-r from-[#203f61] to-[#2a537e] rounded-2xl p-8 text-white">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-200">إنشاء فواتير احترافية وتقارير إحصائية مفصلة</p>
          </div>
          <div className="bg-white bg-opacity-20 rounded-xl px-6 py-4 backdrop-blur-sm">
            <div className="text-3xl font-bold mb-1">{filteredOrders.length}</div>
            <div className="text-gray-200 text-sm">إجمالي الطلبات</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow">
          <div className="flex items-center mb-6">
            <div className="w-14 h-14 bg-gradient-to-br from-[#203f61] to-[#2a537e] rounded-xl flex items-center justify-center ml-4">
              <BarChart3 className="w-7 h-7 text-white" />
            </div>
            <div>
              <h3 className="text-xl font-bold text-gray-900">التقرير الشهري</h3>
              <p className="text-gray-600 text-sm">إحصائيات مفصلة للشهر المحدد</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#203f61] focus:border-[#203f61] transition-all"
                >
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">إحصائيات مفصلة لليوم المحدد</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <select
                  value={selectedYear}
                  onChange={(e) => setSelectedYear(parseInt(e.target.value))}
                  className="w-full px-2 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#203f61] focus:border-[#203f61] transition-all text-sm"
                >
                  {Array.from({ length: 5 }, (_, i) => new Date().getFullYear() - i).map(year => (
                    <option key={year} value={year}>{year}</option>
                  ))}
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
              <FileText className="w-6 h-6 text-[#203f61]" />
              فواتير الطلبات
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-center">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pr-10 pl-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#203f61] focus:border-[#203f61] transition-all"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#203f61] focus:border-[#203f61] transition-all"
            >
            ...
            <div className="bg-gradient-to-r from-[#203f61] to-[#2a537e] rounded-lg p-3 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs opacity-90 mb-1">النتائج</p>
                  <p className="text-xl font-bold">{filteredOrders.length}</p>
                </div>
                <div className="text-left">
                  <p className="text-xs opacity-90 mb-1">الإجمالي</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-[#203f61]">
              <tr>
                <th className="px-6 py-4 text-right text-sm font-semibold text-white">رقم الطلب</th>
                <th className="px-6 py-4 text-right text-sm font-semibold text-white">العميل</th>
                <th className="px-6 py-4 text-right text-sm font-semibold text-white">المبلغ</th>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          disabled={isGenerating}
                          className="p-2 text-[#203f61] hover:bg-[#203f61] hover:text-white rounded-lg transition-all disabled:opacity-50 border border-[#203f61]"
